...
/// TagType to represent tiff values of type `IFD`
#[derive(Clone)]
pub struct Ifd(pub u32);

/// TagType to represent tiff values of type `IFD8`
#[derive(Clone)]
pub struct Ifd8(pub u64);

/// TagType to represent tiff values of type `RATIONAL`
#[derive(Clone)]
pub struct Rational {
    pub n: u32,
    pub d: u32,
...
/// TagType to represent tiff values of type `SRATIONAL`
#[derive(Clone)]
